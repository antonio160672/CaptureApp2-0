...
public class Sqlite_DB_manejo {
    ...
    String[] tablas = {"CREATE TABLE IF NOT EXISTS usuario (id_user INTEGER PRIMARY KEY, nombre text, " +
            ...
            "CREATE TABLE IF NOT EXISTS preguntas_recu(id_preguntas INTEGER PRIMARY KEY,Id_user INTEGER,pregunta1 int, respuesta_1 text, pregunta2 int, respuesta2 text)",
